...
ɪ'ᴍ ʏᴏᴜʀ ꜱᴍᴀʀᴛ ᴀᴜᴛᴏ-ꜰɪʟᴛᴇʀ ʙᴏᴛ 🤖

🎬 ᴍᴏᴠɪᴇꜱ • 📺 ꜱᴇʀɪᴇꜱ • 🍥 ᴀɴɪᴍᴇ • ⭐ ᴀɴᴅ ᴍᴏʀᴇ  
ᴀʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ, ꜰᴀꜱᴛ & ꜱɪᴍᴘʟᴇ.

🔍 ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴛʜᴇ ɴᴀᴍᴇ  
ɪ’ʟʟ ꜰɪɴᴅ ɪᴛ ꜰᴏʀ ʏᴏᴜ ɪɴꜱᴛᴀɴᴛʟʏ ⚡
...
├👨‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href=https://t.me/NeonGhost>NeonGhost </a>
...
╰───────────────⍟</b>"""
    ...
    FORCESUB_TEXT = """<b>🚫 ᴀᴄᴄᴇꜱꜱ ʀᴇꜱᴛʀɪᴄᴛᴇᴅ

ʜᴇʏ {},  
ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ, ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ᴊᴏɪɴ ᴏᴜʀ ᴏꜰꜰɪᴄɪᴀʟ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ 📢

ɪᴛ ʜᴇʟᴘꜱ ᴜꜱ ᴋᴇᴇᴘ ᴛʜᴇ ʙᴏᴛ ꜰʀᴇᴇ & ᴜᴘᴅᴀᴛᴇᴅ ꜰᴏʀ ʏᴏᴜ 💙

👇 ʜᴏᴡ ᴛᴏ ᴜɴʟᴏᴄᴋ ᴀᴄᴄᴇꜱꜱ:
1️⃣ ᴛᴀᴘ **ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ**
2️⃣ ᴊᴏɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ
3️⃣ ᴛᴀᴘ **ᴛʀʏ ᴀɢᴀɪɴ**

✨ ᴛʜᴀɴᴋ ʏᴏᴜ ꜰᴏʀ ʏᴏᴜʀ ꜱᴜᴘᴘᴏʀᴛ & ʜᴀᴘᴘʏ ꜱᴛʀᴇᴀᴍɪɴɢ!</b>"""
...
📜 <a href='https://t.me/+TeFdOlonigowYjY0'>ᴄʜᴇᴄᴋ ᴘʀᴏᴏꜰꜱ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @NeonGhost
...
ᴍᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b>{file_name}\n
📤 ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ: <a href="https://t.me/NeonGhost_Network">NeonGhost_Network</a></b>"""
...
• /details - <code>ᴄʜᴇᴄᴋ ꜱᴇᴛᴛɪɴɢꜱ</code></b>"""
    ...
    SOURCE_TXT = """<b>💻 𝖲𝖮𝖴𝖱𝖢𝖤 & 𝖢𝖴𝖲𝖳𝖮𝖬 𝖡𝖮𝖳𝖲</b> 👇

🤖 ᴡᴀɴᴛ ᴀ ᴄᴜꜱᴛᴏᴍ ᴛᴇʟᴇɢʀᴀᴍ ʙᴏᴛ  
⚙️ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ • ꜰꜱᴜʙ • ᴀᴅᴠᴀɴᴄᴇᴅ ꜰᴇᴀᴛᴜʀᴇꜱ  
🚀 ᴅᴇᴘʟᴏʏᴍᴇɴᴛ & ꜱᴜᴘᴘᴏʀᴛ ɪɴᴄʟᴜᴅᴇᴅ

📩 ꜰᴏʀ:
• ᴄᴜꜱᴛᴏᴍ ʙᴏᴛ ʙᴜɪʟᴅɪɴɢ  
• ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ / ʀᴇᴘᴏ ᴘᴜʀᴄʜᴀꜱᴇ  
• ꜰᴇᴀᴛᴜʀᴇ ᴜᴘɢʀᴀᴅᴇꜱ  
